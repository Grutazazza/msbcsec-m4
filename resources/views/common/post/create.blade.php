        ...
        <div class="row">
            ...
            <div class="col-8">
                @if(session()->has('successPost'))
                    <div class="alert alert-success">Пост успешно добавлен!</div>
                @endif
                <form method="post" action="{{route('common.post.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label for="inputName3" class="col-sm-2 col-form-label">Имя</label>
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="inputName3" aria-describedby="invalidNameFeedback">
                            @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="inputDescription" aria-describedby="invalidDescriptionFeedback">
                            @error('description')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="smalldesc" class="form-control @error('smalldesc') is-invalid @enderror" id="inputSmallDesc3" aria-describedby="invalidSmallDescFeedback">
                            @error('smalldesc')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="tags" class="form-control @error('tags') is-invalid @enderror" id="inputSmallDesc3" aria-describedby="invalidTagsFeedback">
                            @error('tags')
